...
lazy val functionalX = (project in file("presents/functionalX"))
  .settings(commonSettings)
  .settings(
    libraryDependencies ++= Seq(
...
lazy val effects = (project in file("presents/lego-effects"))
  .settings(commonSettings)
  .settings(
    libraryDependencies ++= Seq(
      "co.fs2"            %% "fs2-core"    % "2.5.3",
...
lazy val effectsLive = (project in file("presents/lego-effects-live"))
  .settings(commonSettings)
  .settings(
    libraryDependencies ++= Seq(
      "com.typesafe.akka" %% "akka-http"   % "10.1.11",
